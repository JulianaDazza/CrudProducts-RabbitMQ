...
//import com.unicauca.pago.common.entities.ProductDelivery;
...
public class GUIDeliveryOffice extends javax.swing.JFrame implements ISubscriber {
    ...
    public void onMessage(String msg) {
      Gson gson = new Gson();
      ProductDelivery product = gson.fromJson(msg, ProductDelivery.class);
      modelList.addElement(product.getProductName()); //Esta linea da el elemento que se le quiera dar al rabbit, en este caso se escogio el nombre
